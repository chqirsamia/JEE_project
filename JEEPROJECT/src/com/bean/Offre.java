...
public class Offre {
	...
	public Offre(int id_offre,float reduction_offre, String description,int id,int carton_petit,int carton_moyen,int carton_grand ) {
		super();
		this.id_admin = id;
		this.description = description;
		this.id = id_offre;
	...
	public Offre(int id, float reduction_offre,String description,int carton_petit,int carton_moyen,int carton_grand ) {
		super();
		this.id_admin=id;
		this.description = description;
		this.carton_grand = carton_grand;
