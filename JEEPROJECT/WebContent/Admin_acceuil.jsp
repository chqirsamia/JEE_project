...
<!-- Page d'acceuil -->
<section id="slide" style="background: url('https://nsa40.casimages.com/img/2021/03/01/210301125329772203.jpg');background-size: cover;height:92%">
...
<p></p>
<p class="lead textbg" style="background-color:rgba(41, 128, 185,0.6);font-size:30px;font-weight:bold;font-family:garamond">  Votre espace d'administration  <br> </p><br><br><br><br><br><br><br>
</div>
</div>
</section>
<!--Nos services  -->
<div class="row" id="apropos" style="margin-top: 100px;margin-bottom: 90px;">
