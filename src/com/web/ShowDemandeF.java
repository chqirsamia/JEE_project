...
/**
 * Servlet implementation class ShowDemandeF
 */
@WebServlet("/ShowDemandeF")
public class ShowDemandeF extends HttpServlet {
...
try {
	...
	private void listDemandeF(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException, ServletException {
		List<ListeDemandeSpec> listDemandes = demandeDao.selectAllDemandesF();
