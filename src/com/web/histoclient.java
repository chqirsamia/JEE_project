...
public class histoclient extends HttpServlet {
	...
	public void setOffre(OffreDao offre) {
		this.offre = offre;
	}
	public void setDemande(DemandeDao demande) {
		this.demande = demande;
	}
//    public histoclient(OffreDao o, DemandeDao d) {
//        super();
//        offre = o;
//        demande = d;
//    }
...
//			}
			try {
				...
				//System.out.println(demande.findAllDmds(id_client).get(0).getDemande().getEtat());
