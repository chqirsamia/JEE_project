...
<!-- Page d'acceuil -->
<section id="slide" style="background: url('./ressources/demenagement2.jpg');background-size: cover;" style=" height : 50vh;">
<div class="carousel-item carousel-image-1   active">
 <div class="carousel-caption d-non d-sm-block text-center" >
<h2 class="display-3 d-inline mylead" style="background-color: rgb(119,136,153); font-family:  Lucida Console; font-size:50px;">Offres Actuelles</h2> 
</div>
</div>
</section>
	...
	<div class="row mt-5">
		<c:forEach items="${offres}" var="offre" varStatus="status">
			...
			<div class="card text-center">
			  ...
			  <c:if test="${status.index == 0}"> <i class="fas fa-star fa-2x"></i> </c:if>
			  ...
			  <div class="card-body">
			    ...
			    <p class="card-text">
			    	...
			    	<c:if test = "${offre.carton_grand ne -1}"> Grand carton : ${offre.carton_grand} </c:if>
			    </p>
