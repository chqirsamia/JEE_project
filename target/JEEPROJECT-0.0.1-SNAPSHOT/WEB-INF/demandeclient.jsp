...
<div class="container py-5">
    <div class="row text-center mb-5" style="height:25px;margin-top:70px;">
                                    <span class="inscription-form-title" style="margin-left:350px;font-size:60px;text-align:center;background-color: rgb(176,224,230);height:72.7px; ">
        ...
        <div class="col-md-8">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <h6 class="text-right" style="margin-left:200px!important;font-weight:bold;margin-top:-15px">Nouvelle Demande</h6>
                </div>
                
                <div class="row mt-2">
                
                    <div class="col-md-6"><input type="number" id="petit" class="form-control" min="1" placeholder="Petit Carton" name="pc" ></div>
                    <div class="col-md-6"><input type="number" id="moyen" class="form-control" min="1" name="mc" placeholder="Moyen Carton"></div>
                </div>

                <div class="row mt-3">
                    <div class="col-md-6 mx-auto">
                  		<input type="number" class="form-control" id="grand" min="1" name="gc" placeholder="Grand Carton" value="${val}">                    	
                    </div>
                </div>
                ...
                <button class="btn btn-dark profile-button text-left mt-5" type="submit" name="action" value="price" onclick="afficher()">Prix total de la demande</button>
            </div>
        </div>
    </div>
</div>
      	...
      	<div class="text-center">
      		...
      		<c:if test="${qte.size() gt 1}">
				  ...
				  <thead class="thead-light">
				    <tr>
				      <th scope="col">#</th>
				      <th scope="col" style="text-align:center;">Type Carton</th>
				  ...
				  <c:forEach var="entry" items="${qte }" varStatus="status">        
				   ...
				   <tr> 
				   	<td colspan="3" class="text-center" style="font-weight:bold"> Total : ${cost} Dhs</td>
				   </tr>
				  </tbody>
				</table>
      		</c:if>
      		<c:if test="${!empty offre}">
      			<div class="row">
      				...
      				<div class="col pull-right" style="margin-top:40px;">
      					...
      					<fmt:formatNumber var="total" value="${cost *(1-offre.reduction_offre)}" maxFractionDigits="0" /> <span style="color=blue; font-style:italic; font-weight:bold;">${total} Dhs</span> </h6>
      				</div>
      			</div>
      		</c:if>
      	</div>
...
<script type="text/javascript">
function afficher(){
var saisiep = document.getElementById("petit").value;
document.getElementById("petit").value=saisiep ;
var saisiem = document.getElementById("moyen").value;
document.getElementById("moyen").value=saisiem ;
var saisieg = document.getElementById("grand").value;
document.getElementById("grand").value=saisieg ;
}
</script>
</body>
</html>