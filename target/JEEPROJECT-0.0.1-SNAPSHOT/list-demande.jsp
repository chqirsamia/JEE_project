	                    		...
	                    		<c:set var="totalDmd" value="${0}"/>
	                    			<c:forEach items="${d.lds}" var="lc" varStatus="status">
	                    				<div class="col">
	                    					...
	                    					<h6><i class="fa fa-long-arrow-right mr-1 mb-1"></i><a style="font-weight:bold"> Quantité : </a><c:out value="${lc.cd.nbr}"/></h6>
	                    					<h6><i class="fa fa-long-arrow-right mr-1 mb-1"></i><a style="font-weight:bold"> Prix : </a><c:out value="${lc.carton.prix} Dhs"/></h6>
	                    				</div>
