	                    ...
	                    <div class="row mt-0 font-weight-bold mb-2 dislay-4">
	                    	...
	                    	<div class="col-sm-3">
	                    		<div class="row  border border-info rounded">
	                    					...
	                    					<h6><i class="fa fa-long-arrow-right mr-1 mb-1"></i> numero demande : <c:out value="${d.demande.id}"/></h6>
	                    					<h6><i class="fa fa-long-arrow-right mr-1 mb-1"></i> date de creation : <c:out value="${d.demande.date_creation}"/></h6>
	                    					<h6><i class="fa fa-long-arrow-right mr-1 mb-1"></i> total : <c:out value="${totalDmd}"/>Dhs</h6>
	                    					<h6><i class="fa fa-long-arrow-right mr-1 mb-1"></i> etat de commande: <c:out value="${d.demande.etat}" /></h6>
	                    		...
	                    		<div class="row  border border-info rounded">
	                    					...
	                    					<h6><i class="fa fa-long-arrow-right mr-1 mb-1"></i> prenom : <c:out value="${user.prenom}"/> </h6>
