...
<head>
    ...
    <link Content-Type: text/css href="style.css">
    
    <!--Fichiers-->
    <link rel="icon" type="image/png" href="ressources/logo.png"/>
    <link Content-Type: text/css href="bootstrap.min.css">
	<link Content-Type: text/css href="http://localhost:8088/Plateforme/font-awesome.min.css">
    <title>HSA</title>
</head>
